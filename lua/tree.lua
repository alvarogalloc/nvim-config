...
local tree_keybindings = {
    ...
    {key = "P", cb = tree_cb("parent_node")}, {key = "<BS>", cb = tree_cb("close_node")}, {key = "<S-CR>", cb = tree_cb("close_node")},
    {key = "<Tab>", cb = tree_cb("preview")}, {key = "K", cb = tree_cb("first_sibling")}, {key = "J", cb = tree_cb("last_sibling")},
    {key = "I", cb = tree_cb("toggle_ignored")}, {key = "H", cb = tree_cb("toggle_dotfiles")}, {key = "R", cb = tree_cb("refresh")},
...
require'nvim-tree'.setup {
    ...
    view = {width = 30, height = 30, side = 'left', auto_resize = true, mappings = {custom_only = true, list = tree_keybindings}}
}
